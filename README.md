...
- **Languages & Core:** Python, SQL, Linux & Command Line
- **Data Science & Classical ML:** NumPy, Pandas, Scikit-learn
- **Deep Learning:** TensorFlow, Keras, PyTorch
- **Generative AI & LLMs:** Hugging Face, LangChain, RAG (Retrieval-Augmented Generation), AI Agents
...
- 🧠 Deepening my understanding of Large Language Model (LLM) fine-tuning and agentic workflows.
- ⚙️ Optimizing RAG pipelines for better context retrieval and lower latency.
- 📊 Exploring advanced statistical modeling and deep reinforcement learning.
